...
final class SetonoSyliusImageOptimizerExtension extends Extension implements PrependExtensionInterface
{
    public const LIIP_IMAGINE_EXTENSION_NAME = 'liip_imagine';
